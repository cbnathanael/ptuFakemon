...
<template>
    <div class="move-wrap">
        <div class="move-display" @mouseover="moveData.showDetail = true" @mouseleave="moveData.showDetail = false">
            <div class="svg-wrap" :class="[moveData.move?.type]">
                <svg v-if="moveData.move?.type == 'bug'" fill="none" height="512" viewBox="0 0 512 512" width="512"
                ...
                <svg v-if="moveData.move?.type == 'dark'" width="512" height="512" viewBox="0 0 512 512" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                ...
                <svg v-if="moveData.move?.type == 'dragon'" width="512" height="512" viewBox="0 0 512 512" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd"
                ...
                <svg v-if="moveData.move?.type == 'electric'" width="512" height="512" viewBox="0 0 512 512" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd"
                ...
                <svg v-if="moveData.move?.type == 'fairy'" width="512" height="512" viewBox="0 0 512 512" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd"
                ...
                <svg v-if="moveData.move?.type == 'fighting'" width="512" height="512" viewBox="0 0 512 512" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd"
                ...
                <svg v-if="moveData.move?.type == 'fire'" width="512" height="512" viewBox="0 0 512 512" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd"
                ...
                <svg v-if="moveData.move?.type == 'flying'" width="512" height="512" viewBox="0 0 512 512" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd"
                ...
                <svg v-if="moveData.move?.type == 'ghost'" width="512" height="512" viewBox="0 0 512 512" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd"
                ...
                <svg v-if="moveData.move?.type == 'grass'" fill="none" height="512" viewBox="0 0 512 512" width="512"
                    xmlns="http://www.w3.org/2000/svg">
                    <path clip-rule="evenodd"
                ...
                <svg v-if="moveData.move?.type == 'ground'" width="512" height="512" viewBox="0 0 512 512" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd"
                ...
                <svg v-if="moveData.move?.type == 'ice'" width="512" height="512" viewBox="0 0 512 512" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd"
                ...
                <svg v-if="moveData.move?.type == 'normal'" width="512" height="512" viewBox="0 0 512 512" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd"
                ...
                <svg v-if="moveData.move?.type == 'poison'" width="512" height="512" viewBox="0 0 512 512" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd"
                ...
                <svg v-if="moveData.move?.type == 'psychic'" width="512" height="512" viewBox="0 0 512 512" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd"
                ...
                <svg v-if="moveData.move?.type == 'rock'" width="512" height="512" viewBox="0 0 512 512" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd"
                ...
                <svg v-if="moveData.move?.type == 'steel'" width="512" height="512" viewBox="0 0 512 512" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd"
                ...
                <svg v-if="moveData.move?.type == 'water'" width="512" height="512" viewBox="0 0 512 512" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            <div class="name">{{ moveName }}</div>
        </div>
        <aside class="move-detail" v-if="moveData.showDetail">
            <div class="floating-tip-content">
                <h1 :class="[moveData.move?.type]">{{ moveName }}</h1>
                <dl>
                    <dt>Frequency</dt>
                    <dd>{{ moveData.move?.frequency }}</dd>
                    <dt>AC</dt>
                    <dd>{{ moveData.move?.ac }}</dd>
                    <dt>Type</dt>
                    <dd>{{ moveData.move?.type }}</dd>
                    <dt>Damage Roll/Type</dt>
                    <dd>{{ moveData.move?.damageBase }} / {{ moveData.move?.category }}</dd>
                    <dt>Range</dt>
                    <dd>{{ moveData.move?.range }}</dd>
                    <dt class="effects">Special Effect</dt>
                    <dd class="effects">{{ moveData.move?.effects }}</dd>
                    <dt class="effects">Contest Effect</dt>
                    <dd class="effects">{{ moveData.move?.constestStats }}</dd>
                </dl>
            </div>
        </aside>
    </div>
...
.move-display {
    ...
    .svg-wrap {
        ...
        border-radius: 4px;
        margin-right: 0.5rem;
        box-shadow: 0 0 0 2px rgba($off_white, 0.15);
        svg {
            width: 1.25rem;
            height: 1.25rem;
        }
