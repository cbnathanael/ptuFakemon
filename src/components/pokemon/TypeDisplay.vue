...
<template>
    <div class="type-display" :class="[typeName, displayType]">
        <div class="svg-wrap">
            <svg v-if="typeName == 'bug'" fill="none" height="512" viewBox="0 0 512 512" width="512"
            ...
            <svg v-if="typeName == 'dark'" width="512" height="512" viewBox="0 0 512 512" fill="none"
                xmlns="http://www.w3.org/2000/svg">
            ...
            <svg v-if="typeName == 'dragon'" width="512" height="512" viewBox="0 0 512 512" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            <svg v-if="typeName == 'electric'" width="512" height="512" viewBox="0 0 512 512" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            <svg v-if="typeName == 'fairy'" width="512" height="512" viewBox="0 0 512 512" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            <svg v-if="typeName == 'fighting'" width="512" height="512" viewBox="0 0 512 512" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            <svg v-if="typeName == 'fire'" width="512" height="512" viewBox="0 0 512 512" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            <svg v-if="typeName == 'flying'" width="512" height="512" viewBox="0 0 512 512" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            <svg v-if="typeName == 'ghost'" width="512" height="512" viewBox="0 0 512 512" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            <svg v-if="typeName == 'grass'" fill="none" height="512" viewBox="0 0 512 512" width="512"
                xmlns="http://www.w3.org/2000/svg">
                <path clip-rule="evenodd"
            ...
            <svg v-if="typeName == 'ground'" width="512" height="512" viewBox="0 0 512 512" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            <svg v-if="typeName == 'ice'" width="512" height="512" viewBox="0 0 512 512" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd"
                    d="M384.304 39.0418L385.879 177.392L265.209 235.319L263.721 104.69L384.304 39.0418Z" fill="white" />
                <path fill-rule="evenodd" clip-rule="evenodd"
                    d="M505.269 257.047L385.814 325.374L266.288 256.939L385.752 194.187L505.269 257.047Z"
                    fill="white" />
                <path fill-rule="evenodd" clip-rule="evenodd"
                    d="M245.04 257.047L125.585 325.374L6.05861 256.939L125.523 194.187L245.04 257.047Z" fill="white" />
                <path fill-rule="evenodd" clip-rule="evenodd"
                    d="M124.243 38.4753L248.229 99.881L245.059 233.697L127.993 175.719L124.243 38.4753Z" fill="white" />
                <path fill-rule="evenodd" clip-rule="evenodd"
                    d="M387.678 473.525L263.692 412.119L266.862 278.302L383.928 336.281L387.678 473.525Z"
                    fill="white" />
                <path fill-rule="evenodd" clip-rule="evenodd"
                    d="M128.525 474.77L126.949 336.42L247.62 278.493L249.108 409.121L128.525 474.77Z" fill="white" />
            </svg>
            <svg v-if="typeName == 'normal'" width="512" height="512" viewBox="0 0 512 512" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            <svg v-if="typeName == 'poison'" width="512" height="512" viewBox="0 0 512 512" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            <svg v-if="typeName == 'psychic'" width="512" height="512" viewBox="0 0 512 512" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            <svg v-if="typeName == 'rock'" width="512" height="512" viewBox="0 0 512 512" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            <svg v-if="typeName == 'steel'" width="512" height="512" viewBox="0 0 512 512" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            <svg v-if="typeName == 'water'" width="512" height="512" viewBox="0 0 512 512" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd"
...
div.type-display {
    ...
    .name {
        ...
        z-index: -1;
        line-height: 24px;
        box-shadow: 2px 1px 3px rgba(#3a3a3a, 0.5);
    }
